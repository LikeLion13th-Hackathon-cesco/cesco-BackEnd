...
public class AddressSearchController {
  ...
  @Operation(summary = "커뮤니티 주소 검색 결과 반환 API",
      description = "커뮤니티 페이지에서 검색 했을때 검색 결과 반환")
  @PostMapping("/address-search")
  public ResponseEntity<BaseResponse<List<AddressSearchResponse>>> searchCommunity(@RequestBody AddressSearchRequest addressSearchRequest) {

    List<AddressSearchResponse> addressSearchResponseList = addressSearchService.searchAddress(addressSearchRequest);
